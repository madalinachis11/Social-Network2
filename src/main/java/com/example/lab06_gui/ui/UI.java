...
public class UI {
    ...
    private void adaugaUtilizator(){
        ...
        if(service.addUser(string2, string3, string4, string5)) //if(service.addUser(ID, string2, string3, string4, string5, string6))
    ...
    private void modificaUtilizator(){
        ...
        if(service.updateUser(ID, string2, string3, string4, string5))
